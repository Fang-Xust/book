...
public class BorrowRecordDAO {
    ...
    public static int insert(BorrowRecord record) {
        ...
        try{
            ...
            throw new SystemException("00011", "插入图书借阅信息出错", e);
        }finally {
            DBUtil.close(c, ps);
        }
    }
    ...
    public static int update(BorrowRecord record) {
        ...
        try{
            ...
            throw new SystemException("00012", "修改图书借阅信息出错", e);
        }finally {
            DBUtil.close(c, ps);
        }
    }
    ...
    public static int delete(String[] ids) {
        ...
        try{
            ...
            throw new SystemException("00013", "删除图书借阅信息出错", e);
        }finally {
            DBUtil.close(c, ps);
        }
    }
